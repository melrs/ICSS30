...
from config import PAYMENT_PUBLIC_KEY_FILE, PAYMENT_APPROVED_QUEUE, PAYMENT_DECLINED_QUEUE, RESERVATION_CREATED_QUEUE, TICKET_ISSUED_QUEUE, ITINERARIES_FILE

ch = create_channel()

for queue in [RESERVATION_CREATED_QUEUE, PAYMENT_APPROVED_QUEUE, PAYMENT_DECLINED_QUEUE, TICKET_ISSUED_QUEUE]:
...
ch.basic_consume(queue=PAYMENT_APPROVED_QUEUE, on_message_callback=handle_payment_approved, auto_ack=True)
